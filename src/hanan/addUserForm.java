...
public class addUserForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton_male.setBackground(new java.awt.Color(255, 204, 204));
        jRadioButton_male.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButton_male.setText("Male");

        jRadioButton_female.setBackground(new java.awt.Color(255, 204, 204));
        ...
        button_Cancel.setBackground(new java.awt.Color(102, 51, 0));
        ...
        button_Add1.setBackground(new java.awt.Color(102, 51, 0));
    ...
    private void button_Add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_Add1ActionPerformed
        ...
        if(verifText()){
            user std = new user();
            std.insertUpdateDeleteUser('i', null, fname, lname, sex, phone, address);
           
            manageUser.jTable1.setModel(new DefaultTableModel(null,new Object[]{"Id","First Name","Last Name","Sex","Phone","Address"}));

            std.Fill_User_Table(manageUser.jTable1,"");
